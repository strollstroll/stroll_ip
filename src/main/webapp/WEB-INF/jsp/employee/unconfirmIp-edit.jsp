...
<body>
  ...
  <form class="layui-form">
    ...
    <div class="layui-input-block">
      <input type="text" name="unconfirmId" lay-verify="unconfirmId" value="${ip.unconfirmId}" disabled="disabled" value="${ip.ipStatus}" autocomplete="off" placeholder="待审核的id" class="layui-input">
    </div>
  	</div>
  <div class="layui-form-item">
    <label class="layui-form-label">序号</label>
    <div class="layui-input-block">
      <input type="text" name="ipNumber" lay-verify="number" value="${ip.ipNumber}" disabled="disabled" value="${ip.ipStatus}" autocomplete="off" placeholder="待审核，还未分配序号" class="layui-input">
    </div>
  	</div>
  	<div class="layui-form-item">
...
<div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" name="ipAddressnumber" lay-verify="ipAddressnumber" value="${ip.ipAddressnumber}" autocomplete="off" placeholder="请输入地址数量" class="layui-input">
    </div>
  </div>
 <div class="layui-form-item">
...
<div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" name="ipUsername" lay-verify="usename" value="${ip.ipUsername}" autocomplete="off" placeholder="请输入用户名称" class="layui-input">
    </div>
  </div>
<div class="layui-form-item">
...
<div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" name="ipAttribution" lay-verify="ipAttribution" value="${ip.ipAttribution}" autocomplete="off" placeholder="请输入运维系统编号" class="layui-input">
    </div>
  </div>
<div class="layui-form-item">
    <label class="layui-form-label">宽带受理编号</label>
    <div class="layui-input-block">
      <input type="text" name="ipBroadbandacceptancenumber" lay-verify="broadbandacceptancenuber" value="${ip.ipBroadbandacceptancenumber}" autocomplete="off" placeholder="请输入宽带受理编号" class="layui-input">
    </div>
  </div>
<div class="layui-form-item">
...
<div class="layui-form-item">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" name="unconfirmStatus" lay-verify="confirmStatus" value="${ip.unconfirmStatus}" autocomplete="off" disabled="disabled" class="layui-input">
    </div>
  </div>
   <div class="layui-form-item">
    <div class="layui-input-block">
