...
<script id="toolbar" type="text/html">
    <button class="layui-btn layui-btn-normal layui-btn layui-btn-xs"  onclick="openWin('审核操作','/school/admin/toEdit.do?id={{d.id}}')" >
...
<script>
    ...
    layui.use(['table','layer','laydate','form'],function () {
        ...
        t=table.render({
            elem:'#infoTable',
            url:'/school/teacher/getAudit.do',
            cols:[[
                {type:'checkbox'},
                {field:'id',title:'编号',sort:true},
                {field:'remake',title:'申请事物'},
